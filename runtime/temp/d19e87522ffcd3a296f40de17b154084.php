<?php /*a:2:{s:78:"D:\phpStudy\PHPTutorial\WWW\xcx\application\user\view\item\category\index.html";i:1542612824;s:65:"D:\phpStudy\PHPTutorial\WWW\xcx\application\user\view\layout.html";i:1543209671;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="tips layer-margin-bottom-sm layer-u-sm-12">
                        <div class="pre">
                            <p> 注：商品分类最多添加2级，分类图片可参考
                                <a href="<?= url('app.page/category') ?>" target="_blank">分类页模板</a> 上传</p>
                        </div>
                    </div>
                            ...
                            <div class="layer-btn-toolbar">
                                <div class="layer-btn-group layer-btn-group-xs">
                                    <a class="layer-btn layer-btn-default layer-btn-success layer-radius"
                                       href="<?php echo url('item.category/add'); ?>">
                    ...
                    <div class="layer-u-sm-12">
                        <table width="100%" class="layer-table layer-table-compact layer-table-striped tpl-table-black ">
                            ...
                            <?php if((!empty($list))): foreach($list as $first): ?>
                                <tr>
                                    <td class="layer-text-middle"><?php echo htmlentities($first['category_id']); ?></td>
                                    <td class="layer-text-middle"><?php echo htmlentities($first['name']); ?></td>
                                    <td class="layer-text-middle"><?php echo htmlentities($first['sort']); ?></td>
                                    <td class="layer-text-middle"><?php echo htmlentities($first['create_time']); ?></td>
                                    <td class="layer-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <a class="tpl-table-black-operation-warning" href="<?php echo url('item/index',
                                                ['category_id' => $first['category_id']]); ?>">
                                                <i class="layer-icon-pencil"></i> 商品列表
                                            </a>
											<a href="<?php echo url('item.category/edit',
                                                ['category_id' => $first['category_id']]); ?>">
                                                <i class="layer-icon-pencil"></i> 编辑
                                            </a>
                                            <a href="javascript:;" class="item-delete tpl-table-black-operation-del"
                                               data-id="<?php echo htmlentities($first['category_id']); ?>">
								...
								<?php if(isset($first['child'])): foreach($first['child'] as $two): ?>
                                    ...
                                    <tr>
                                        <td class="layer-text-middle"><?php echo htmlentities($two['category_id']); ?></td>
                                        <td class="layer-text-middle">　-- <?php echo htmlentities($two['name']); ?></td>
                                        <td class="layer-text-middle"><?php echo htmlentities($two['sort']); ?></td>
                                        <td class="layer-text-middle"><?php echo htmlentities($two['create_time']); ?></td>
                                        <td class="layer-text-middle">
                                            <div class="tpl-table-black-operation">
												<a class="tpl-table-black-operation-warning" href="<?php echo url('item/index',
                                                ...
                                                <a href="javascript:;" class="item-delete tpl-table-black-operation-del"
                                                   data-id="<?php echo htmlentities($two['category_id']); ?>">
                                                    <i class="layer-icon-trash"></i> 删除
                                                </a>
                                            </div>
                                        </td>
									...
									<?php if(isset($two['child'])): foreach($two['child'] as $three): ?>
                                        ...
                                        <tr>
                                            <td class="layer-text-middle"><?php echo htmlentities($three['category_id']); ?></td>
                                            <td class="layer-text-middle">　　　-- <?php echo htmlentities($three['name']); ?></td>
                                            <td class="layer-text-middle"><?php echo htmlentities($three['create_time']); ?></td>
                                            <td class="layer-text-middle">
                                                <div class="tpl-table-black-operation">
                                                    <a href="<?php echo url('item.category/edit',
                                                    ...
                                                    <a href="javascript:;"
                                                       ...
                                                       data-id="<?php echo htmlentities($three['category_id']); ?>">
                                                        <i class="layer-icon-trash"></i> 删除
                                                    </a>
                                                </div>
                                            </td>
...
<script>
    $(function () {
        // 删除元素
        var url = "<?php echo url('item.category/delete'); ?>";
