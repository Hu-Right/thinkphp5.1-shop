<?php /*a:2:{s:80:"D:\phpStudy\PHPTutorial\WWW\xcx\application\user\view\setting\express\index.html";i:1541754388;s:65:"D:\phpStudy\PHPTutorial\WWW\xcx\application\user\view\layout.html";i:1543209671;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="layer-u-sm-12 layer-u-md-12 layer-u-lg-12">
            <div class="widget layer-cf">
                <div class="widget-head layer-cf">
                    <div class="widget-title layer-cf">物流公司列表</div>
                </div>
                            ...
                            <div class="layer-btn-toolbar">
                                <div class="layer-btn-group layer-btn-group-xs">
                                    <a class="layer-btn layer-btn-default layer-btn-success layer-radius"
                                       href="<?php echo url('setting.express/add'); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td class="layer-text-middle">
                                            <div class="tpl-table-black-operation">
                                                <a href="<?php echo url('setting.express/edit',
