<?php /*a:2:{s:75:"D:\phpStudy\PHPTutorial\WWW\xcx\application\user\view\store\user\index.html";i:1543201678;s:65:"D:\phpStudy\PHPTutorial\WWW\xcx\application\user\view\layout.html";i:1543209671;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                         ...
                         tpl-table-black layer-text-nowrap">
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <td class="layer-text-middle"><?= $item['user_name'] ?></td>
                                    <td class="layer-text-middle"><?= $item['real_name'] ?></td>
                                    <td class="layer-text-middle"><?= $item['create_time'] ?></td>
                                    <td class="layer-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (($store['user']['user_id'] != $item['user_id'])
                                                && !$item['is_super']): ?>
                                                    <a href="<?= url('store.user/edit', ['user_id' => $item['user_id']]) ?>">
