<?php /*a:2:{s:67:"D:\phpStudy\PHPTutorial\WWW\xcx\application\user\view\item\end.html";i:1543314564;s:65:"D:\phpStudy\PHPTutorial\WWW\xcx\application\user\view\layout.html";i:1543209671;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <tr>
                                    ...
                                    <td class="layer-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <a class="tpl-table-black-operation-green j-state"  data-id="<?php echo htmlentities($item['item_id']); ?>" >
                                                恢复
                                            </a>
                                        </div>
                                    </td>
    ...
    $(function () {
        ...
        $('.j-state').click(function () {
            ...
            layer.confirm('确定要' + (parseInt(data.state) === 10 ? '下架' : '恢复') + '该商品吗？'
                , {title: '友情提示'}
                , function (index) {
                    $.post("<?php echo url('item/recovery'); ?>"
                        , {
                            item_id: data.id
                        }
                        , function (result) {
