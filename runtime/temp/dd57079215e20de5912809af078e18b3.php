<?php /*a:2:{s:81:"D:\phpStudy\PHPTutorial\WWW\xcx\application\user\view\setting\delivery\index.html";i:1541754430;s:65:"D:\phpStudy\PHPTutorial\WWW\xcx\application\user\view\layout.html";i:1543209671;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="layer-u-sm-12 layer-u-md-12 layer-u-lg-12">
            <div class="widget layer-cf">
                <div class="widget-head layer-cf">
                    <div class="widget-title layer-cf">运费模板</div>
                </div>
                            ...
                            <div class="layer-btn-toolbar">
                                <div class="layer-btn-group layer-btn-group-xs">
                                    <a class="layer-btn layer-btn-default layer-btn-success layer-radius"
                                       href="<?php echo url('setting.delivery/add'); ?>">
                        ...
                        <table width="100%" class="layer-table layer-table-compact layer-table-striped tpl-table-black ">
                            ...
                            <?php if((!$list->isEmpty())): foreach($list as $item): ?>
                                    <tr>
                                        ...
                                        <td class="layer-text-middle"><?php echo htmlentities($item['method']['text']); ?></td>
                                        ...
                                        <td class="layer-text-middle">
                                            <div class="tpl-table-black-operation">
                                                <a href="<?php echo url('setting.delivery/edit',
